...
import { Search, RotateCw, Download, Eye, X } from 'lucide-react';
  ...
  const columns = [
    {
      ...
      render: (val, row) => (
        ...
        >
          {val || `TXN${String(row.id || '').padStart(4, '0')}`}
        </span>
      ),
    },
    {
    ...
    },
    {
      ...
      render: (val) => {
        ...
        const styles =
          s === 'successful' || s === 'success' || s === 'completed'
            ...
            <div className="p-6 space-y-4 text-xs">
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                ...
                <span className="font-mono text-[#E94B4B] font-bold">
                  {selectedTxn.txnId || `TXN${selectedTxn.id}`}
                </span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                ...
                <span className="text-gray-200">{selectedTxn.paymentMethod || 'UPI'}</span>
              </div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-white/5">
                ...
                <span
                  className={`font-bold capitalize ${
                    selectedTxn.status === 'successful' || selectedTxn.status === 'completed'
                      ? 'text-green-400'
