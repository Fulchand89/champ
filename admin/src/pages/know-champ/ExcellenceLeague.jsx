            ...
            <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-[#131722] to-[#0b0d14] border border-white/10 shadow-2xl space-y-8 backdrop-blur-xl">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full sm:w-auto inline-flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-gradient-to-r from-red-600 to-red-500 hover:from-red-500 hover:to-red-600 text-white font-extrabold text-sm sm:text-base shadow-xl shadow-red-500/30 hover:shadow-red-500/50 hover:-translate-y-0.5 active:translate-y-0 transition-all duration-200 cursor-pointer"
                >
